...
public class Common {
    ...
    public static CharSequence buildWelcomeMessage() {
        if (Common.currentUser != null) {
            return new StringBuilder("Welcome ")
                    .append(Common.currentUser.getFirstName().toString())
                    .append(" ")
    ...
    public static void showNotification(Context context, int id, String title, String body, Intent intent) {
        ...
        String NOTIFICATION_CHANNEL_ID = "PALASH_CHANNEL";
        NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "Uber Driver", NotificationManager.IMPORTANCE_HIGH);
            notificationChannel.setDescription("Uber Driver");
